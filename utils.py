...
def evaluate_score_multi(y_real, y_predict, y_real_c, y_pred_c, logger):
    listOfAppliance = ['microwave', 'washer_dryer', 'dishwasher', '3ph_fridge_1']
    mapeScore = []
...
def genList(appliance, j):
    thre = [1567,1893,2335, 3720, 30]  #microwave, washer dryer, dishwasher, 3ph_fridge_1
    ontol = [.8*1567, .8*1893, .8*2335, .8*3720, 30]
    offtol = [.2*1567, .2*1893,.2*2335, .2*3720, 10]
